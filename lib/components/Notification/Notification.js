...
require('pnotify/dist/pnotify.history.css');
...
var Notification = function (_React$Component) {
  ...
  _createClass(Notification, [{
    ...
    value: function _renderPNotify() {
      var widget = new _pnotify2.default(this.props);
